    ...
    <div className="flex">
      ...
      {/* <div className="centerCon">
        <div className="w-5/6 flex flex-col">
          ...
          <div className={`${styles.dashBoardCarousel} pl-10 w-6/6 mt-10 flex items-center justify-beween`}>
            <div className="w-3/6 h-4/6 flex flex-col justify-between">
                <h1>Carry out check on a drug</h1>
                <h6 className="mb-5">Clic on the barcode icon to verify the originality of your drug.</h6>
